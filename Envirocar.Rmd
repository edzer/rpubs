...
importEnviroCar = function(file) {
  ...
  # TODO hard coded; needs to be read from server in future
  colNames = c("Speed","Consumption","Calculated.MAF", "Intake.Pressure", "CO2", "Intake.Temperature","MAF","Rpm","Throttle.Position","Engine.Load")
  ...
  # set the units:
  # TODO hard coded; needs to be read from server in future 
  units = c("km/h","l/h","g/s","kPa","kg/h","C","l/s","u/min","%","%")
